# help
HELP_MESSAGE = "StickerInator is made to help you with creating stickerpacks with images, videos and telegram bubbles!\n\n"+\
    "Available commands:\n"+\
...
VIDEO_CROP_MESSAGE = "Video duration is {} seconds, maximum duration is 3 seconds\n"+\
...
INVALID_VIDEO_DURATION_MESSAGE = "Invalid start timestamp and duration, reply with start time followed by duration\"mm:ss.S s.S\"\n"+\
                                            "(m for minutes, s for seconds, S for fraction of a second)"

STICKER_EMOJI_MESSAGE = "Please send a emoji for the sticker"

ADD_NEXT_STICKER_MESSAGE = "Please send another sticker OR reply with DONE when finished"
...
VIDEO_TOO_LONG_MESSAGE = "Video duration is too long, crop video by replying with start time followed by duration\"mm:ss.S s.S\"\n"\
    +"(m for minutes, s for seconds, S for fraction of a second)"
